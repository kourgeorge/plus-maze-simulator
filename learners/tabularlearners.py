...
class AsymmetricQLearner(AbstractLearner):
    def __init__(self, model: QTable, learning_rate_rewarded=config.LEARNING_RATE,
                 learning_rate_nonrewarded=config.LEARNING_RATE, *args, **kwargs):
        super().__init__(model=model, optimizer={'learning_rate_rewarded': learning_rate_rewarded,
                                                 'learning_rate_nonrewarded': learning_rate_nonrewarded})
...
class AsymmetricIALearner(AbstractLearner):
    ...
    def __init__(self, model: FTable, learning_rate_rewarded=config.LEARNING_RATE,
                 learning_rate_nonrewarded=config.LEARNING_RATE, *args, **kwargs):
        super().__init__(model=model, optimizer={'learning_rate_rewarded': learning_rate_rewarded,
                                                 'learning_rate_nonrewarded': learning_rate_nonrewarded})
...
class MALearner(AsymmetricIALearner):
